...
echo "Google will be opened now..."
google-chrome

echo "Sign in with your Google account and sync the settings"
echo "Press Enter to continue"
read voidInput

echo "Log in into your google account or create a new one"
